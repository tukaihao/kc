<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/home/www/kc/public/../application/admin/view/panel/useredit.html";i:1496714364;s:68:"/home/www/kc/public/../application/admin/view/public/base_admin.html";i:1496714364;s:64:"/home/www/kc/public/../application/admin/view/public/tongji.html";i:1496714364;}*/ ?>
<!DOCTYPE HTML>
<html>
 <head>
...
<div class="weui-cells weui-cells_form">
	...
	<div class="weui-cell">
		...
		<div class="weui-cell__bd">
			<input class="weui-input" type="email" id="setting_email"  placeholder="登陆邮箱" value="<?php echo $one['email']; ?>"/>
		</div>
	</div>
	...
	<div class="weui-cell weui-cell_select weui-cell_select-after">
		...
		<div class="weui-cell__bd">
			<select class="weui-select" name="status" id="input_status">
				...
				<option value="1" <?php if($one['status'] == 1): ?>selected="true"<?php endif; ?>>--正常-正常使用--</option>
				<option value="2" <?php if($one['status'] == 2): ?>selected="true"<?php endif; ?>>--锁定-不能登陆--</option>
			</select>
		</div>
	</div>
	...
	<div class="weui-cell">
		...
		<div class="weui-cell__bd">
			<input class="weui-input" type="text" id="setting_realname"  placeholder="管理员姓名" value="<?php echo $one['realname']; ?>"/>
		</div>
	</div>
	<div class="weui-cell">
		<div class="weui-cell__hd"><label class="weui-label">电话</label></div>
		<div class="weui-cell__bd">
			<input class="weui-input" type="tel" id="setting_tel"  placeholder="管理员电话" value="<?php echo $one['tel']; ?>"/>
		</div>
	</div>
...
<script>
var _form_action = '<?php echo \think\Url::build('useredit');?>',_id = '<?php echo $one['id']; ?>';
